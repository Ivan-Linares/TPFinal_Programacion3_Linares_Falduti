...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Nosotros">
        ...
        <div class="Contenedor2" style="background-image: url(imagenes/destacada2.jpg)">
            <!--Titulo de pagina-->
                            ...
                            <!--Componente de acordeon para la mision, visión y los valores-->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <h4 class="mb-0">
                                            <a class="btn btn-link" data-toggle="collapse" data-target="#tab-mision" aria-controls="collapseOne">Nuestro compromiso
                                            </a>
                                        </h4>
                                    </div>
