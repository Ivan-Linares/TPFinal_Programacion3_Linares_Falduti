...
AS 
BEGIN
INSERT INTO VISITAS(FECHA,HORA,NOMBRE,APELLIDO,NUM_PROPIEDAD,ESTADO)
VALUES (
@FECHA,
@HORA,
@NOMBRE,
...
AS 
BEGIN
UPDATE  VISITAS SET FECHA=@FECHA,HORA=@HORA,NOMBRE=@NOMBRE,APELLIDO=@APELLIDO,NUM_PROPIEDAD=@NUMPROPIEDAD,ESTADO=@ESTADO
END
GO