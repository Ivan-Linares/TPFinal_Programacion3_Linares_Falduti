...
AS 
BEGIN
SELECT  u.IDUSUARIO, u.NIVEL_ACCESO, u.EMAIL, u.CONTRESEÑA
FROM USUARIOS AS U
WHERE U.EMAIL=@USER AND U.CONTRESEÑA=@PASS
END
GO
...
AS
BEGIN
	SELECT V.IDVISITA, V.IDPROPIEDAD, V.IDVENDEDOR, V.IDUSUARIO, V.FECHA, V.HORA, V.ESTADO FROM VISITAS V
	WHERE V.IDUSUARIO = @IDUSUARIO
END
GO

CREATE PROC SP_LISTAR_VISITAR_PORID_VENDEDOR (@IDVENDEDOR INT)
AS
BEGIN
	SELECT V.IDVISITA, V.IDPROPIEDAD, V.IDVENDEDOR, V.IDUSUARIO, V.FECHA, V.HORA, V.ESTADO FROM VISITAS V
