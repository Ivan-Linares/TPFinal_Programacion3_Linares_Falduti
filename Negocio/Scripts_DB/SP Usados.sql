...
AS
BEGIN
SELECT U.IDUSUARIO, U.NOMBRE, U.APELLIDO, U.EMAIL, U.FECHA_NACIMIENTO, TxU.TIPO,  U.CONTRESEÑA, U.ESTADO
FROM USUARIOS U
INNER JOIN TIPO_USUARIO TxU ON TxU.TIPO = U.NIVEL_ACCESO
...
AS 
BEGIN
INSERT INTO VISITAS(FECHA,HORA,NOMBRE,APELLIDO,NUM_PROPIEDAD,TELEFONO,ESTADO)
VALUES (
@FECHA,
@HORA,
@NOMBRE,
...
-------------------------------------------------------------------------
ALTER PROC SP_MODIFICAR_VISITA (
@IDVISTA INT,
@FECHA DATE,
@HORA  TIME,
@NOMBRE VARCHAR(50),
...
AS 
BEGIN
UPDATE  VISITAS SET FECHA=@FECHA,HORA=@HORA,NOMBRE=@NOMBRE,APELLIDO=@APELLIDO,NUM_PROPIEDAD=@NUMPROPIEDAD,TELEFONO=@TELEFONO,ESTADO=@ESTADO
END
GO